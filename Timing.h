...
//		}
//
//		__forceinline static void startTiming(const std::string& name = std::string(""))
//		{
//			TimingHelper h;
...
//		}
//
//		__forceinline static double stopTiming(bool print = true)
//		{
...
//		}
//
//		__forceinline static double stopTiming(bool print, int& id)
//		{
//			if (id == -1)
//				id = IDFactory::getId();
//
...
//					std::cout << h.name.c_str() << ": " << t << " ms" << std::endl;
//				if (id >= 0)
//				{
...
//		}
//
//		__forceinline static void printAverageTimes()
//		{
//			LOG_INFO << "---------------------------------------------------------------------------\n";
//			std::unordered_map<int, AverageTime>::iterator iter;
...
//		}
//
//		__forceinline static void printTimeSums()
//		{
//			std::unordered_map<int, AverageTime>::iterator iter;
//			for (iter = Timing::m_averageTimes.begin(); iter != Timing::m_averageTimes.end(); iter++)
//			{
